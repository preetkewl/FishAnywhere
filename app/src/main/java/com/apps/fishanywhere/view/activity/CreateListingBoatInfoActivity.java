...
public class CreateListingBoatInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_listing_boat_info);
        ...
        iv_cllist_paging.setImageDrawable(getResources().getDrawable(R.drawable.im_cl_boat_info));

        tv_createlist_heading = (TextView) findViewById(R.id.tv_createlist_heading);
        tv_createlist_heading.setText(getResources().getText(R.string.boatinfo));


        tv_createlist_subheading = (TextView) findViewById(R.id.tv_createlist_subheading);
        tv_createlist_subheading.setText(getResources().getText(R.string.boatsubheading));
    }
